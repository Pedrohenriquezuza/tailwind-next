...
export default function NavItem({ title, icon: Icon }: NavItemProps) {
  return (
    <a
      href="#"
      className="group flex items-center gap-3 rounded px-3 py-2 hover:bg-violet-50 outline-none focus:border-violet-300 focus:ring-4 focus:ring-violet-100 
      dark:hover:bg-zinc-800 dark:focus-within:border-violet-500 dark:focus-within:ring-violet-500/20
      "
    >
